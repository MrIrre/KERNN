...
class MyNN(torch.nn.Module):
    def __init__(self, vocab_size, embedding_size=64):
        ...
        self.conv1 = torch.nn.Conv1d(in_channels=64, out_channels=64, kernel_size=(3, 3), stride=2**1)
        self.act1 = torch.nn.ReLU()
        self.dropout1 = torch.nn.Dropout(p=0.5)

        self.conv2 = torch.nn.Conv1d(in_channels=64, out_channels=64, kernel_size=(3, 3), stride=2**2)
        self.act2 = torch.nn.ReLU()
        self.dropout2 = torch.nn.Dropout(p=0.5)

        self.conv3 = torch.nn.Conv1d(in_channels=64, out_channels=64, kernel_size=(3, 3), stride=2**3)
        self.act3 = torch.nn.ReLU()
        self.dropout3 = torch.nn.Dropout(p=0.5)

        self.conv4 = torch.nn.Conv1d(in_channels=64, out_channels=64, kernel_size=(3, 3), stride=2**4)
        self.act4 = torch.nn.ReLU()
        self.dropout4 = torch.nn.Dropout(p=0.5)

        self.conv5 = torch.nn.Conv1d(in_channels=64, out_channels=64, kernel_size=(3, 3), stride=2**5)
        self.act5 = torch.nn.ReLU()
        self.dropout5 = torch.nn.Dropout(p=0.5)

        self.conv6 = torch.nn.Conv1d(in_channels=64, out_channels=64, kernel_size=(3, 3), stride=2**6)
